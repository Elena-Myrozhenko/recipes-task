        ...
        <Grid.Row>
            ...
            <Segment basic inverted>
              <small>
                ...
                <List bulleted>
                  ...
                  <List.Item>
                    The required ingredients along with their quantities or
                    proportions
                  </List.Item>
                  <List.Item>
                    Necessary equipment and environment needed to prepare the
                    dish
                  </List.Item>
                  <List.Item>
                  ...
                  <List.Item>
                    The number of servings that the recipe will provide (the
                    "yield")
                  </List.Item>
          ...
          <Grid.Column>
            <Segment basic inverted>
              <small>
                <p>
                  Some recipes will note how long the dish will keep and its
                  suitability for freezing. Nutritional information, such as
                  calories per serving and grams of protein, fat, and
                  carbohydrates per serving, may also be given.
                  <br />Earlier recipes often included much less information,
                  serving more as a reminder of ingredients and proportions for
                  someone who already knew how to prepare the dish.
                  <br />Recipe writers sometimes also list variations of a
                  traditional dish, to give different tastes of the same
                  recipes.
                </p>
              </small>
            </Segment>
            ...
            <Segment basic inverted>
              <small>
                <p>
                  ...
                  and advice on purchasing quality ingredients or making
                  substitutions.
                  <br />Cookbooks can also cover a wide variety of topics,
                  including cooking techniques for the home, recipes and
                  commentary from famous chefs, institutional kitchen manuals,
