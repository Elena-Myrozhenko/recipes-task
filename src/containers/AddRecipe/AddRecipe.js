        ...
        <Form onSubmit={this.handleSubmit}>
          <Segment padded attached="top">
            ...
            <Form.Group widths="equal">
              <Form.TextArea
                name="ingredients"
                label="Ingredients"
                placeholder="e.g. 4 firm, almost-ripe pears (Bartlett or Bosc), peeled, cored, and cut lengthwise..."
                rows="3"
              />
              <Form.TextArea
                name="directions"
                label="Directions"
                placeholder="e.g. Bring a large pot of salted water to a boil over high heat..."
                rows="3"
              />
            </Form.Group>
            <Divider />
            ...
            <Form.Field
              ...
              selection
              allowAdditions
              noResultsMessage="Type new #hashtag and press Enter or use Space to create tags automatically."
              options={tagsOptions}
              value={tags}
          ...
          <Button.Group attached="bottom">
            <Button
              type="reset"
              color="grey"
              onClick={() => this.refs.addRecipeModal.handleClose()}
            >
